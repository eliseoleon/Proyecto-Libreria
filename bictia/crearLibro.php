...
$tablaautor = $connmysqli->query("SELECT * FROM autor");

$tablacategoria = $connmysqli->query("SELECT * FROM categoria");

$tablaeditorial = $connmysqli->query("SELECT * FROM editorial");

$tablacomentarios = $mysqli_query($this->conn, $sql);
...
<head>
    <link rel="stylesheet" href="estilosLibro.css">
    <title></title>
</head>
<script>
